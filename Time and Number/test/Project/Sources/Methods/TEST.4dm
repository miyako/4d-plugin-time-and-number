...
$e:=TIME Date to text(Current date:C33; Current time:C178; 0; "GMT"; $dateString)
...
If (False:C215)
	...
	//Japan Standard Time
	$e:=TIME Date to text(Current date:C33; Current time:C178; Milliseconds:C459; "EST"; TIME ISO Date Zone Generic; $out)
	//Japan Time
	$e:=TIME Date to text(Current date:C33; Current time:C178; Milliseconds:C459; "EST"; TIME ISO Date Zone Location; $out)
