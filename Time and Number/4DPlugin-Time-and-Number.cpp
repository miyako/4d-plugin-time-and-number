...
#include "4DPlugin-Time-and-Number.h"
...
void PluginMain(PA_long32 selector, PA_PluginParameters params) {
	...
	try
	{
        switch(selector)
        {
			...
			case 1 :
				TIME_Get_offset(params);
				break;
			case 2 :
				TIME_Date_to_text(params);
				break;
			case 3 :
				TIME_Date_from_text(params);
				break;
			case 4 :
				TIME_Absolute_from_text(params);
				break;
			case 5 :
				TIME_Absolute_to_text(params);
				break;
			case 6 :
				TIME_Date_from_absolute(params);
				break;
			case 7 :
				TIME_Date_to_absolute(params);
				break;
			case 8 :
				TIMEZONE_Get_region(params);
				break;
			case 9 :
				TIMEZONE_Get_default(params);
				break;
			case 10 :
				TIMEZONE_Get_offset(params);
				break;
			case 11 :
				TIMEZONE_Get_display_name(params);
				break;
			case 12 :
				TIMEZONE_Get_GMT(params);
				break;
			case 13 :
				NUMBER_Format(params);
				break;
			case 14 :
				TIMEZONE_GET_LIST(params);
				break;
